...
exports.getDefaultReservoirParams = getDefaultReservoirParams;
exports.calculateInjectivity = calculateInjectivity;
exports.calculateMaterialBalance = calculateMaterialBalance;
exports.evaluateWhatIf = evaluateWhatIf;
/** Delaware Basin CO2-EOR typical reservoir parameters */
function getDefaultReservoirParams(patternId) {
 ...
 *   s = skin factor
 */
function calculateInjectivity(reservoir, currentBHP, skinFactor = 0) {
 ...
 */
function calculateMaterialBalance(reservoir, currentPressure, cumulativeOil, cumulativeCO2Injected) {
 ...
 */
function evaluateWhatIf(wellId, wellName, currentOilRate, currentPressure, currentInjRate, currentNetback, reservoir, scenario, oilPrice = 72, co2Price = 1.05) {
